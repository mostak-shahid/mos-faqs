...
namespace MosPress\MosFaqs\CLI;
use WP_CLI;

/**
 * Class CLI_Command
 *
 * Handles WP-CLI commands for Mos FAQs.
 */
class CLI_Command {
     ...
     *     wp mos-faqs seed-logs
     *
     *     # Create 50 log entries
     *     wp mos-faqs seed-logs --count=50
     *
     ...
     *     wp mos-faqs clear-logs
     *
     *     # Clear logs without confirmation
     *     wp mos-faqs clear-logs --yes
     *
     * @param array $args       Positional arguments.
     * @param array $assoc_args Associative arguments.
     */
     ...
     *
     *     # Show 10 recent logs
     *     wp mos-faqs show-logs
     *
     *     # Show 20 recent logs in JSON format
     *     wp mos-faqs show-logs --limit=20 --format=json
     *
     * @param array $args       Positional arguments.
     * @param array $assoc_args Associative arguments.
     */
