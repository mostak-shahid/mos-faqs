...
class LogsController
{
    ...
    {
        global $wpdb;
        $this->logs_table_name = $wpdb->prefix . 'mos_faqs_logs';
    }

	public static function log_settings_reset($section, $old_data, $new_data)
	{
		global $wpdb;
		$logs_table_name = $wpdb->prefix . 'mos_faqs_logs';
		...
		$wpdb->insert(
			...
			[
                ...
                'category' => __('Settings Reset', 'mos-faqs'),
	...
	public static function log_settings_change($old_data, $new_data)
	{
		...
		$wpdb->insert(
			...
			[
                ...
                'category' => __('Settings Change', 'mos-faqs'),
