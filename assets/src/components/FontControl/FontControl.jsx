    ...
    return (
        <>
            <div className={`font-wrapper ${className}`}>
                <Space align='center'>
                    <Switch 
                        aria-label={__('Enable Font Options', 'mos-faqs')}
                        checked={enableFont}
                        onChange={(enabled) => updateValue('enabled', enabled)}
                    />
                    <Typography.Title heading={6} style={{ margin: 8 }}>
                        {enableFont ? __('Enabled', 'mos-faqs') : __('Disabled', 'mos-faqs')}
                    </Typography.Title>
                </Space>  
                {
                    enableFont && 
                                        ...
                                        (
                                            <>
                                                ...
                                                <Select
                                                    ...
                                                    //     return {
                                                    //         label: __(valStr.charAt(0).toUpperCase() + valStr.slice(1), 'mos-faqs'),
                                                    //         value: valStr,
                                                    //     };
                                                    // })}
