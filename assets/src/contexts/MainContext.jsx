...
const settingsMenu = [
    {
        itemKey: "page",
        text: __("Page", "mos-faqs"),
        description: __("Page", "mos-faqs"),
        url: "/settings/page",
        icon: <IconUser />,
        items: [
            {
                itemKey: "page-1",
                text: __("Page 1", "mos-faqs"),
                description: __("Page 1", "mos-faqs"),
                url: "/settings/page/page-1",
            },
            {
                itemKey: "page-2",
                text: __("Page 2", "mos-faqs"),
                description: __("Page 2", "mos-faqs"),
...

    {
        ...
        text: __("Import & Expport", "mos-faqs"),
