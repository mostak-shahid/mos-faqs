...
const copyToClipboard = (value) => {
    if (!value) {
        Notification.error({
            ...
            content: __("No text to copy", "mos-faqs"),
            duration: 3,
            position: 'topRight',
        });
        return;
        ...
        navigator.clipboard.writeText(value)
            .then(() => {
                Notification.success({
                    ...
                    content: __("Copied to clipboard", "mos-faqs"),
                    duration: 3,
                    position: 'topRight',
                });
            })
...
const fallbackCopyToClipboard = (value) => {
    ...
    try {
        ...
        if (successful) {
            ...
            Notification.error({
                title: __("Error", "mos-faqs"),
                content: __("Failed to copy", "mos-faqs"),
                duration: 3,
                position: 'topRight',
            });
        }
        ...
        Notification.error({
            title: __("Error", "mos-faqs"),
            content: __("Copy not supported in this browser", "mos-faqs"),
            duration: 3,
            position: 'topRight',
        });
    } finally {
...
const Tools = () => {
    ...
    //                 path: `/mos-faqs/v1/deactivation-link` 
    //             });
    ...
    //             Toast.error({
    //                 content: __("Error fetching deactivation URL", "mos-faqs"),
    //                 theme: "light",
    //             });
    //         } finally {
    ...
    const handleClick = async () => {
        ...
        try {
            const result = await apiFetch({
                path: "/mos-faqs/v1/options/reset-settings-all",
                method: "POST",
            });
            ...
            if (result.success) {
                Notification.success({
                    title: __("Success", "mos-faqs"),
                    content: __("Settings reset successfully!", "mos-faqs"),
                    duration: 3,
                    position: 'topRight',
                });
            } else {
            ...
            Notification.error({
                title: __("Error", "mos-faqs"),
                content: __("Error resetting settings.", "mos-faqs"),
                duration: 3,
                position: 'topRight',
            });
        } finally {
        ...
        <>
                    ...
                    <Col xs={24} lg={12} xl={10}>
                        <Select
                            ...
                            optionList={[
                                ...
                                { label: __("Delete", "mos-faqs"), value: "delete" },
                                { label: __("Deactivate", "mos-faqs"), value: "deactivate" },
                            ]}
                        />
                    </Col>
                </Row>
            ...
            <div className="setting-unit pt-4">
                <Row gutter={[24, 24]} align="middle">
                    <Col xs={24} lg={12} xl={14}>
                        <Title heading={4}>
                            {__("Reset Plugin", "mos-faqs")}
                        </Title>
                        <Paragraph>
                            {__("Reset Plugin to it's default settings", "mos-faqs")}
                        </Paragraph>
                    </Col>

                    <Col xs={24} lg={12} xl={10}>
                        <Popconfirm
                            title={__("Are you sure you want to proceed?", "mos-faqs")}
                        ...
                        >
                            ...
                            >
                                {processing
                                    ? __("Resetting...", "mos-faqs")
                                    : __("Reset All", "mos-faqs")}
                            </Button>
                        </Popconfirm>
                    </Col>
                </Row>
            ...
            {/* <div className="setting-unit pt-4">
                <Row gutter={[24, 24]} align="middle">
                    <Col xs={24} lg={12} xl={14}>
                        <Title heading={4}>
                            {__("Deactivate Plugin URL", "mos-faqs")}
                        </Title>
                        <Paragraph>
                            {deactivationError 
                                ? deactivationError
                                : __("Use this secure URL to deactivate the plugin. This link will only work once.", "mos-faqs")
                            }
                        </Paragraph>
                    </Col>
                        ...
                        <Input
                            ...
                            placeholder={
                                deactivationLoading 
                                    ? __("Loading...", "mos-faqs")
                                    : deactivationError
                                    ? __("Failed to load URL", "mos-faqs")
                                    : __("Deactivation URL", "mos-faqs")
                            }
                            suffix={
                                <Button
                                    theme="borderless"
