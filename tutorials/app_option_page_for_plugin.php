...
public function add_plugin_admin_menu() {
     ...
     */
    add_submenu_page( 'plugins.php', 'Plugin settings page title', 'Admin area menu slug', 'manage_options', 'text-domain', array( $this, 'display_plugin_setup_page' ) );
...
public function add_action_links( $links ) {
     ...
     */
    $settings_link = array( '<a href="' . admin_url( 'plugins.php?page=' . $this->plugin_name ) . '">' . __( 'Settings', 'text-domain' ) . '</a>', );

    // -- OR --

    // $settings_link = array( '<a href="' . admin_url( 'options-general.php?page=' . $this->plugin_name ) . '">' . __( 'Settings', 'text-domain' ) . '</a>', );
...
public function options_update() {
    ...
    register_setting( $this->plugin_name, 'text-domain', array(
