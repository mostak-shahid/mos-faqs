...
const GeneralUnit = ({handleChange}) => {
    const {
        settingData,
        settingLoading
    } = useMain();
                    ...
                    <div className="col-lg-7">
                        {
                            ...
                            : <h4>{__("Unit View", "mos-faqs")}</h4>
                        }
                        {
                            settingLoading 
                            ? <div className="loading-skeleton p" style={{width: '70%'}}></div>
                            : <p>{__("Choose how your FAQs are shown to your user.", "mos-faqs")}</p>
                        }
                    </div>    
                    {
                        !settingLoading &&                               
                        <div className="col-lg-5">
                            <select 
                                ...
                                value={settingData?.general?.unit?.view} 
                                onChange={(e) => handleChange('general.unit.view', e.target.value)}
                                //
                            >
                                <option value="collapsible">{__('Collapsible', 'mos-faqs')}</option>
                                <option value="accordion">{__('Accordion', 'mos-faqs')}</option>
                                <option value="block">{__('Block', 'mos-faqs')}</option>
                            </select>                         
                        </div>
                    }
                </div>
...
export default withForm(GeneralUnit);